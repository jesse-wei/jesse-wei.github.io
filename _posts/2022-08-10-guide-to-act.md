...
* There are lots of math questions in which a single small but important detail in the question completely changes the answer. You should {{< rawhtml >}}<ins>underline</ins>{{< /rawhtml >}} those small details so that you don't forget about them while you're solving the problem.
